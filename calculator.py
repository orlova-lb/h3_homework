...
class Calculator(tk.Frame):
    ...
    def _create_buttons_frame(self):
        buttons_frame = tk.Frame(self.master, bd=3, bg='#C0C0C0')
        ...
        for button in self.BUTTONS_LIST:
            tk.Button(buttons_frame, text=button, bg='#808080', font='16', relief='groove',
